...
1. **Practice truth and first use:** every bounded practice claim or promised practice contribution names its exact subject and scope and carries its own obtaining or possible-future status, practitioner, difficulty, sought result, first use, non-use boundary, qualification window, and receiving decision. The answer as a whole has no single truth-branch value.
