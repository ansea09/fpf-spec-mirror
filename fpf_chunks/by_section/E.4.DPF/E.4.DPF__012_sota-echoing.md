...
| Pattern-language adequacy needs domain-use and validation evidence rather than a broad name, rule of three, singleton veto, or merely different terminology. | Riehle, Harutyunyan, and Barcomb, `Pattern Discovery and Validation Using Scientific Research Methods`, final publication 2025, `https://doi.org/10.1007/978-3-662-70810-1_6`; Chuprina et al., `Towards an Approach to Pattern-based Domain-Specific Requirements Engineering`, 2024 academia-industry proof of concept, `https://arxiv.org/abs/2404.17338`; Marchezan de Paula et al., `Software product line scoping: A systematic literature review`, 2022 family-scope comparison, `https://doi.org/10.1016/j.jss.2021.111189`; Iba, `Pattern Languages as Media for the Creative Society`, 2013 historical lineage, `https://arxiv.org/abs/1308.1178`. | `E.4.DPF:4.0` applies the `E.8:4.1.3` same-situation action test, keeps maintained result, `MethodDescription`, direct-source evidence, and unavailability distinct, and opens `E.4.DPF.DA` package coverage only after a material promised-family change; exact-basis reuse avoids proof-of-revisit work. E.8 drafting, E.21 evaluation, representative cases, seed-versus-reliance separation, and E.23 improvement remain the wider authoring route. | **Adapt and bound.** Adopt actual-use validation, domain action change, honest external-result return, and separate family-scope recheck. Reject title or count specificity, universal feature-model or software-product ontology, and proof that a revisit occurred. Reopen this decision if current evidence changes the action test, external-result boundary, family-scope trigger, or exact-basis reuse condition. |
