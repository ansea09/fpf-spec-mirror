...
Commit SHA: `b22b6993b3e94f7896d5dc1cd011af7bc3f49b0d`
...
- [A.2.4 — U.EvidenceRole](by_pattern/A.2.4.md)
- [A.2.5 — U.RoleStateGraph: The Named State Space of a Role](by_pattern/A.2.5.md)
- [A.2.6 — Unified Scope Mechanism (USM): Context Slices & Scopes](by_pattern/A.2.6.md)
- [A.2.7 — U.RoleAlgebra: In‑Context Role Relations](by_pattern/A.2.7.md)
...
- [F.4 — Role Description (RCS + RoleStateGraph + Checklists)](by_pattern/F.4.md)
- [F.5 — Naming Discipline for U.Types & Roles](by_pattern/F.5.md)
- [F.6 — Role Assignment & Enactment Cycle (Six-Step)](by_pattern/F.6.md)
- [F.7 — Concept‑Set Table](by_pattern/F.7.md)
- [F.8 — Mint or Reuse? (U.Type vs Concept-Set vs Role Description vs Alias)](by_pattern/F.8.md)
- [F.9 — Alignment & Bridge across Contexts](by_pattern/F.9.md)
- [F.9.1 — Bridge Stance Overlay](by_pattern/F.9.1.md)
- [F.10 — Status Families Mapping (Evidence • Standard • Requirement)](by_pattern/F.10.md)
...
- [F.14 — Anti‑Explosion Control (Roles & Statuses)](by_pattern/F.14.md)
- [F.15 — SCR/RSCR Harness for Unification](by_pattern/F.15.md)
