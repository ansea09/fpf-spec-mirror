...
| Permission, non-prohibition, exercise, non-violation, or conflict | State which permission-side question is current and name its participants and context. | Use the exact A.2.8.PER result. Credential, system-role label, assignment, capability, gate, status, or silence in an incomplete frame proves none of them. |
