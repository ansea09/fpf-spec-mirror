...
* **Informs:** `E.18` and `E.18.1` when transduction-graph or P2W wording must keep graph representation or path representation separate from method claims and work claims.
